		...
		<div id="main">
			<div id="mainBg">
				<div id="mainPanel">
					...
					<div id="right">
						<form name="loginForm" action="<%=path%>/user/user_regist.action" method="post">
							
							<div id="welcome">
								<span id="welcome-text">用&nbsp;户&nbsp;注&nbsp;册</span>
							</div>
							<div>
								<s:actionerror />
								<s:fielderror />
							...
							<div id="user-name">
								...
								<span><input type="text" name="uemail" class="form-input"></span>
							</div>
							
							<div id="user-name">
								<span class="item">学&nbsp;&nbsp;&nbsp;院:</span> 
								<span><input type="text" name="deptname" class="form-input"></span>
							</div>
							<div id="user-name">
								<span class="item">身&nbsp;&nbsp;&nbsp;份:</span> 
								<span>&nbsp;&nbsp;
