...
<body>
	...
	<div id="mainContainer">
		...
		<form action="<%=path%>/borrow/borrow_borrow.action"
			method="post">
			<input type="hidden"  name="islonguse" value="1" />
			<table width="600">
				<tr>
					<td width="30%">教室名称:</td>
					<td>
						<input type="text" readonly="readonly" name="cname" value="<s:property value="cname"/>" /><br /><br />
					</td>
				</tr>
				...
				<tr>
					<td colspan="2"><input class="button" type="submit" value="长期借用"></td>
				</tr>
			</table>
		</form>
